...
public data class Channel(
    ...
    val memberCapabilities: Set<String> = setOf(),
...
public fun Channel.mergeChannelFromEvent(that: Channel): Channel {
    return copy(
        ...
        lastMessageAt = when {
            that.lastMessageAt == null -> lastMessageAt
            lastMessageAt == null -> that.lastMessageAt
            else -> {
                if (that.lastMessageAt.after(lastMessageAt)) that.lastMessageAt else this.lastMessageAt
            }
        },
