...
/**
 * The default implementation of [ErmisMediaRecorder], used as a wrapper around [MediaRecorder] simplifying
 * working with it.
 *
 * @param context The [Context] necessary to prepare for recording.
 */
public class DefaulErmisMediaRecorder(
     ...
     */
    private var onStartRecordingListener: ErmisMediaRecorder.OnRecordingStarted? = null

    /**
     * Updated when the media recorder stops recording.
     */
    private var onStopRecordingListener: ErmisMediaRecorder.OnRecordingStopped? = null

    /**
     * Updated when a new max amplitude value is emitted.
     */
    private var onMaxAmplitudeSampledListener: ErmisMediaRecorder.OnMaxAmplitudeSampled? = null

    /**
     * Updated when the media recorder state changes.
     */
    private var onStreamMediaRecorderStateChangedListener: ErmisMediaRecorder.OnMediaRecorderStateChange? = null

    /**
     * Updated when the duration of the currently active recording changes.
     */
    private var onCurrentRecordingDurationChangedListener: ErmisMediaRecorder.OnCurrentRecordingDurationChanged? = null
    ...
    private fun trackMaxDuration() {
        ...
        currentRecordingDurationJob = coroutineScope.launch {
            while (mediaRecorderState == MediaRecorderState.RECORDING) {
                val activeRecordingStartedAt = this@DefaulErmisMediaRecorder.activeRecordingStartedAt
                val currentDuration =
     ...
     */
    override fun setOnErrorListener(onErrorListener: ErmisMediaRecorder.OnErrorListener) {
     ...
     */
    override fun setOnInfoListener(onInfoListener: ErmisMediaRecorder.OnInfoListener) {
    ...
    /**
     * Sets an [ErmisMediaRecorder.OnRecordingStarted] listener on this instance of [ErmisMediaRecorder].
     *
    ...
    override fun setOnRecordingStartedListener(onRecordingStarted: ErmisMediaRecorder.OnRecordingStarted) {
        this.onStartRecordingListener = onRecordingStarted
    }

    /**
     * Sets an [ErmisMediaRecorder.OnRecordingStopped] listener on this instance of [ErmisMediaRecorder].
     *
     * @param onRecordingStopped [ErmisMediaRecorder.OnRecordingStarted] SAM used to notify the user after the
     * recording has stopped.
     */
    // TODO evaluate for removal due to new state updater
    override fun setOnRecordingStoppedListener(onRecordingStopped: ErmisMediaRecorder.OnRecordingStopped) {
     ...
     */
    override fun setOnMaxAmplitudeSampledListener(onMaxAmplitudeSampled: ErmisMediaRecorder.OnMaxAmplitudeSampled) {
    ...
    override fun setOnMediaRecorderStateChangedListener(
        onMediaRecorderStateChange: ErmisMediaRecorder.OnMediaRecorderStateChange,
    ) {
    ...
    override fun setOnCurrentRecordingDurationChangedListener(
        onCurrentRecordingDurationChanged: ErmisMediaRecorder.OnCurrentRecordingDurationChanged,
    ) {
