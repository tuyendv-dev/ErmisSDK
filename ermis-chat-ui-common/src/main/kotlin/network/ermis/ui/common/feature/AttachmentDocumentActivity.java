package network.ermis.ui.common.feature;
...
public class AttachmentDocumentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ermis_activity_attachment_document);
    ...
    public void loadDocument(String url) {
        ...
        if (ErmisClient.instance().isSocketConnected()) {
        ...
        public void onPageFinished(WebView view, String url) {
            if (view.getTitle().equals("")) {
                if (reloadCount < maxReloadCount) {
                    ...
                    String errorMsg = AttachmentDocumentActivity.this.getString(R.string.ermis_ui_message_list_attachment_load_failed);
