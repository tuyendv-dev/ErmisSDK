package network.ermis.ui.common.contract
...
public class CaptureMediaContract(private val mode: Mode) :
    ...
    private fun Mode.label(context: Context): String = context.getString(
        when (this) {
            Mode.PHOTO -> R.string.ermis_ui_message_composer_capture_media_take_photo
            Mode.VIDEO -> R.string.ermis_ui_message_composer_capture_media_video
            Mode.PHOTO_AND_VIDEO -> R.string.ermis_ui_message_composer_capture_media
        },
    )
}
