...
-keep class * extends network.ermis.client.api.model.dto.ExtraDataDto {
...
-keep class network.ermis.client.call.RetrofitCall { *; }
...
-keep class * extends network.ermis.client.clientstate.UserState

# Classes that are used by reflection.
-keep class network.ermis.client.notifications.ChatPushDelegate { *; }