...
internal class ToggleAdapter(context: Context) :
    ArrayAdapter<Pair<String, Boolean>>(context, R.layout.ermis_toggle_list_item, emptyList()) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val itemView =
            convertView ?: LayoutInflater.from(parent.context).inflate(R.layout.ermis_toggle_list_item, parent, false)
