...
import network.ermis.ui.components.databinding.MediaAttachmentViewBinding
...
internal class MediaAttachmentView : ConstraintLayout {
    ...
    /**
     * Binding for [R.layout.media_attachment_view].
     */
    internal val binding: MediaAttachmentViewBinding =
        MediaAttachmentViewBinding.inflate(streamThemeInflater).also {
    ...
    private fun showMoreCount(andMoreCount: Int) {
        ...
        binding.moreCountLabel.text =
            context.getString(R.string.ermis_ui_message_list_attachment_more_count, andMoreCount)
    }
