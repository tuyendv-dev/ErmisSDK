...
import network.ermis.core.extensions.limitTo
...
import network.ermis.ui.components.databinding.MessageComposerDefaultCenterOverlapContentBinding
...
public open class DefaultMessageComposerOverlappingContent : ConstraintLayout, MessageComposerOverlappingContent {
    ...
    private val binding: MessageComposerDefaultCenterOverlapContentBinding
    ...
    init {
        ...
        binding = MessageComposerDefaultCenterOverlapContentBinding.inflate(inflater, this)
        ...
        centerContentHeight = context.getDimension(R.dimen.ui_message_composer_center_content_height)
    ...
    private fun renderHold(state: RecordingState.Hold) {
        ...
        binding.recordingPlayback.setImageResource(R.drawable.ic_mic)
        binding.recordingPlayback.setImageColorRes(R.color.ui_accent_red)
    ...
    private fun renderOverview(state: RecordingState.Overview) {
        ...
        binding.recordingPlayback.setImageColorRes(R.color.ui_accent_blue)
    ...
    private fun showMicPopup() {
        ...
        val micContent = LayoutInflater.from(context).inflate(
            R.layout.message_composer_default_center_overlap_floating_mic,
            this,
            false,
        ).also { imageView ->
    ...
    private fun showLockPopup() {
        ...
        val lockContent = LayoutInflater.from(context).inflate(
            R.layout.message_composer_default_center_overlap_floating_lock,
            this,
            false,
        ).also { imageView ->
            (imageView as ImageView).apply {
    ...
    private fun showLockedPopup() {
        ...
        val lockContent = LayoutInflater.from(context).inflate(
            R.layout.message_composer_default_center_overlap_floating_locked,
            this,
            false,
        ).also { imageView ->
            (imageView as ImageView).apply {
    ...
    private fun showHoldPopup() {
        val holdContent = LayoutInflater.from(context).inflate(
            R.layout.message_composer_default_center_overlap_floating_hold,
            this,
            false,
        ).also {
