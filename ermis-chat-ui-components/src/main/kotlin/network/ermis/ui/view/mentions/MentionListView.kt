...
import network.ermis.ui.components.databinding.MentionListViewBinding
...
public class MentionListView : ViewFlipper {
    ...
    private val binding = MentionListViewBinding.inflate(streamThemeInflater, this)
    ...
    public fun showError() {
        Toast.makeText(context, R.string.ermis_ui_mention_list_error, Toast.LENGTH_SHORT).show()
    }
