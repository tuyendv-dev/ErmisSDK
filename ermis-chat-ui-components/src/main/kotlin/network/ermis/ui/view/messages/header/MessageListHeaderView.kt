...
import network.ermis.ui.components.databinding.MessageListHeaderViewBinding
import network.ermis.ui.font.setTextStyle
import network.ermis.ui.utils.extensions.EMPTY
import network.ermis.ui.utils.extensions.createStreamThemeWrapper
import network.ermis.ui.utils.extensions.setTextSizePx
import network.ermis.ui.utils.extensions.streamThemeInflater

public class MessageListHeaderView : FrameLayout {

    private val binding = MessageListHeaderViewBinding.inflate(streamThemeInflater, this, true)
    ...
    public fun setTitle(title: String) {
        reduceHeaderState(
            ...
            threadModeSubtitle = context.getString(R.string.ermis_ui_message_list_header_thread_subtitle, title),
        )
    }
    ...
    private fun configBackButton() {
        ...
        binding.backButtonBadge.apply {
            ...
            ContextCompat.getDrawable(context, R.drawable.badge_bg)?.let {
    ...
    private companion object {
        private fun createInitialHeaderState(context: Context): HeaderState {
            return HeaderState(
                ...
                threadModeTitle = context.getString(R.string.ermis_ui_message_list_header_thread_title),
