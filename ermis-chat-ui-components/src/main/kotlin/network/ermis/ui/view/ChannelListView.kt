...
import network.ermis.ui.view.channels.actions.ChannelActionsDialogFragment
import network.ermis.ui.view.ChannelListView.ChannelClickListener
import network.ermis.ui.view.ChannelListView.ChannelListItemPredicate
import network.ermis.ui.view.ChannelListView.ChannelListUpdateListener
import network.ermis.ui.view.ChannelListView.ChannelLongClickListener
import network.ermis.ui.view.ChannelListView.ErrorEventHandler
...
import network.ermis.ui.view.channels.SimpleChannelListView
...
public class ChannelListView : FrameLayout {
    ...
    private var channelMarkAsReadListener: ChannelClickListener = ChannelClickListener.DEFAULT
    ...
    private var errorEventHandler = ErrorEventHandler { errorEvent ->
        when (errorEvent) {
            is ChannelListViewModel.ErrorEvent.HideChannelError -> R.string.ermis_ui_channel_list_error_hide_channel
            is ChannelListViewModel.ErrorEvent.DeleteChannelError -> R.string.ermis_ui_channel_list_error_delete_channel
            is ChannelListViewModel.ErrorEvent.LeaveChannelError -> R.string.ermis_ui_channel_list_error_leave_channel
        }.let(::showToast)
    }
    ...
    public fun setChannelMarkAsReadClickListener(listener: ChannelClickListener?) {
        channelMarkAsReadListener = listener ?: ChannelClickListener.DEFAULT
    }
                    ...
                    .apply {
                        setChannelOptionClickListener { channelAction ->
                            when (channelAction) {
                                ...
                                is MarkAsRead -> channelMarkAsReadListener.onClick(channelAction.channel)
