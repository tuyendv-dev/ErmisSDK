...
internal class WaveformView : LinearLayoutCompat {
    ...
    init {
        ...
        slider = ImageView(context).apply {
            setBackgroundResource(R.drawable.share_rectangle)
            isVisible = false
        }
    ...
    private val paintPassed = Paint().apply {
        color = ContextCompat.getColor(context, R.color.ui_accent_blue)
        style = Paint.Style.FILL
    }

    private val paintUpcoming = Paint().apply {
        color = ContextCompat.getColor(context, R.color.ui_grey)
        style = Paint.Style.FILL
    }
