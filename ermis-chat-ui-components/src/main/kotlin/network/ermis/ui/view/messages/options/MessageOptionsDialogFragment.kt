...
import network.ermis.ui.components.databinding.DialogMessageOptionsBinding
...
public class MessageOptionsDialogFragment : FullScreenDialogFragment() {
    ...
    private var _binding: DialogMessageOptionsBinding? = null
    ...
    private val optionsOffset: Int by lazy { requireContext().getDimension(R.dimen.ui_spacing_medium) }
    ...
    override fun onCreateView(
        ...
        return DialogMessageOptionsBinding.inflate(inflater, container, false)
            .apply { _binding = this }
            .root
    }
    ...
    private fun anchorReactionsViewToMessageView() {
        ...
        val reactionsOffset = context.getDimension(R.dimen.ermis_ui_edit_reactions_horizontal_offset)
