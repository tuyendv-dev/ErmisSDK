...
import network.ermis.ui.components.databinding.FragmentChannelListBinding
import network.ermis.ui.view.channels.header.ChannelListHeaderView
import network.ermis.ui.view.ChannelListView
import network.ermis.ui.view.messages.screen.MessageListActivity
import network.ermis.ui.view.search.SearchInputView
import network.ermis.ui.view.search.SearchResultListView
import network.ermis.ui.utils.extensions.findListener
...
public open class ChannelListFragment : Fragment() {
    ...
    protected val binding: FragmentChannelListBinding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        return FragmentChannelListBinding.inflate(layoutInflater, container, false)
            .apply { _binding = this }
            .root
    }
