...
internal class MessageListItemAdapter(
    ...
    var messageDisplayListener: ((messageDisplayId: String) -> Unit)? = null
    ...
    override fun onBindViewHolder(
        ...
        if (getItem(position) is MessageListItem.MessageItem) {
            val messageDisplayId = (getItem(position) as MessageListItem.MessageItem).message.id
            messageDisplayListener?.invoke(messageDisplayId)
        }
    }
