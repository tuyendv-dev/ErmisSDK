...
import network.ermis.ui.components.databinding.MessageComposerDefaultCenterContentBinding
...
public open class DefaultMessageComposerCenterContent : FrameLayout, MessageComposerCenterContent {
     ...
     */
    protected lateinit var binding: MessageComposerDefaultCenterContentBinding
     ...
     */
    private fun init() {
        binding = MessageComposerDefaultCenterContentBinding.inflate(streamThemeInflater, this)
