...
import network.ermis.ui.utils.util.openSystemSettings
...
public class PermissionChecker {
    ...
    private fun checkStoragePermissions(
        ...
        checkPermissions(
            view,
            view.context.getString(R.string.ermis_ui_message_composer_permission_storage_title),
            view.context.getString(R.string.ermis_ui_message_composer_permission_storage_message),
            view.context.getString(R.string.ermis_ui_message_composer_permission_setting_message),
            permissions,
            onPermissionDenied,
            onPermissionGranted,
        )
    ...
    public fun checkCameraPermissions(
        ...
        checkPermissions(
            view,
            view.context.getString(R.string.ermis_ui_message_composer_permission_camera_title),
            view.context.getString(R.string.ermis_ui_message_composer_permission_camera_message),
            view.context.getString(R.string.ermis_ui_message_composer_permission_camera_message),
    ...
    public fun checkAudioRecordPermissions(
        ...
        checkPermissions(
            view,
            view.context.getString(R.string.ermis_ui_message_composer_permission_audio_record_title),
            view.context.getString(R.string.ermis_ui_message_composer_permission_audio_record_message),
            view.context.getString(R.string.ermis_ui_message_composer_permission_audio_record_message),
    ...
    private fun showPermissionDeniedSnackbar(
        ...
        Snackbar.make(view, snackbarMessage, Snackbar.LENGTH_LONG).apply {
            setAction(R.string.ermis_ui_message_composer_permissions_setting_button) {
