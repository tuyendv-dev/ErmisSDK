...
object Versions {
    ...
    internal const val MACRO_BENCHMARK = "1.3.0"
...
//    const val detektFormatting = "io.gitlab.arturbosch.detekt:detekt-formatting:${Versions.DETEKT_PLUGIN}"
    ...
    const val flipperNoop = "com.facebook.flipper:flipper-noop::${Versions.FLIPPER_SO_LOADER}"
    ...
    const val serverSentEvents = "com.squareup.okhttp3:okhttp-sse:${Versions.OKHTTP}"
