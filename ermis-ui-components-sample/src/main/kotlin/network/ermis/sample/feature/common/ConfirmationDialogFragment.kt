...
package network.ermis.sample.feature.common
...
import network.ermis.chat.ui.sample.databinding.ConfirmationDialogFragmentBinding
...
internal class ConfirmationDialogFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun newDeleteMessageInstance(context: Context): ConfirmationDialogFragment = newInstance(
            ...
            title = context.getString(R.string.ermis_ui_message_list_delete_confirmation_title),
            description = context.getString(R.string.ermis_ui_message_list_delete_confirmation_message),
            confirmText = context.getString(R.string.ermis_ui_message_list_delete_confirmation_positive_button),
            cancelText = context.getString(R.string.ermis_ui_message_list_delete_confirmation_negative_button),
        )
        ...
        fun newLeaveChannelInstance(context: Context, channelName: String): ConfirmationDialogFragment = newInstance(
            ...
            iconTintResId = R.color.ui_grey,
            title = context.getString(R.string.chat_group_info_option_leave),
            description = context.getString(R.string.chat_group_info_leave_confirm),
        ...
        fun newFlagMessageInstance(context: Context): ConfirmationDialogFragment = newInstance(
            ...
            iconTintResId = R.color.red,
            title = context.getString(R.string.ermis_ui_message_list_flag_confirmation_title),
            description = context.getString(R.string.ermis_ui_message_list_flag_confirmation_message),
            confirmText = context.getString(R.string.ermis_ui_message_list_flag_confirmation_positive_button),
            cancelText = context.getString(R.string.cancel),
        )
